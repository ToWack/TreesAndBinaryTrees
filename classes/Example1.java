...
public class Example1 {
    ...
    static LinkedBinaryTree<Integer> tree = new LinkedBinaryTree<>();
    /** creating scanner object for user inputs */
	static Scanner scan = new Scanner(System.in);
    /** creating and initializing root */
    static Position<Integer> root = null;
	...
	public static void main(String[] args) {
        ...
        do {
            ...
            try {
				...
				System.out.println("EmptyTreeException: " + ex.getMessage());
			} catch(InvalidPositionException ex) {
				System.out.println("InvalidPositionException: " + ex.getMessage());
			} catch(UnemptyTreeException ex) {
				System.out.println("UnemptyTreeException: " + ex.getMessage());
